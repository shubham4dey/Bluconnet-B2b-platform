...
export default function Employees() {
  ...
  // RBAC: Admins (HR) cannot create, edit, or delete Super Admin accounts
  // and cannot change user roles — they manage regular employees only.
  const isAdminOnly = role === 'ADMIN';
  const canTouchRow = (emp: any) => !isAdminOnly || emp.role !== 'SUPER_ADMIN';
